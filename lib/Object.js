...
d(Object.prototype, {
  ...
  ...adapterMethods(Object, 0, null, ['entries','entries0'], ['keys','keys0'], ['values','values0'], ['assign','assign0']),
  ...adapterMethods(JSON, 0, null, ['stringify','stringify0']),
  merge0: function(...args) {
    return ObjectMerge(this, ...args);
  },
  concat0: function(...args) {
  ...
  pipe0: function(pipe, ...args) {
    return pipe(this, ...args);
  },
  handle0: function(handle, ...args) {
    return handle(this, ...args), this;
  },
  toArray0: function() {
