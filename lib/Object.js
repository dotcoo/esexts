...
d(Object.prototype, {
  ...
  attr0: function(name, ...args) {
    return typeof this != 'object' ? this : typeof name == 'function' ? name(this, ...args) : args.length == 0 ? this[name] : (null === args[1] ? Object.defineProperty(this, name, { value: args[0], enumerable: false, configurable: true, writable: true }) : 'object' === typeof args[1] ? Object.defineProperty(this, name, { value: args[0], ...args[1] }) : ((undefined === args[1] || (name in this) === args[1]) && (this[name] = args[0])), this);
  },
  attr1: function(...keys) {
    const o = typeof keys.last0() === 'object' ? keys.pop() : { enumerable: false, configurable: true, writable: true };
    return Object.defineProperties(this, keys.reduce((a, c) => a.attr0(c, { value: this[c], ...o }), {}));
  },
  call0: function(...args) {
    return typeof this != 'function' ? this : this(...args);
  },
  toArray0: function() {
