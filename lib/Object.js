...
import { d, adapterMethods, adapterMethodsReturnThis } from './util';
...
d(Object.prototype, {
  ...
  ...adapterMethods(Object, ['entries','entries0'], ['keys','keys0'], ['values','values0']),
  merge0: function(...args) {
    return ObjectMerge(this, ...args);
  },
  concat0: function(...args) {
  ...
  ...adapterMethodsReturnThis(console, ['debug', 'debug0'], ['log', 'log0'], ['info', 'info0'], ['warn', 'warn0'], ['error', 'error0'], ['dir', 'dir0']),
  // ====== Tree ======
