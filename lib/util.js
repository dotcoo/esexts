...
function adapterMethods(prototype, thisIndex, returnArgs, ...alias) {
  ...
  for (const [o, n] of alias) {
    if      (returnArgs === null)  { defines[n] = function(...args) { return prototype[o].apply(this, insert(args, thisIndex, this)); }; }
    else if (returnArgs === false) { defines[n] = function(...args) { return prototype[o].apply(this, insert(args, thisIndex, this)), this; }; }
    else if (returnArgs === true)  { defines[n] = function(...args) { return prototype[o].apply(this, insert(args, thisIndex, this)), args; }; }
