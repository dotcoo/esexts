...
Object.defineProperties(Object.prototype, {
  clone0: {
    value: function() {
      return typeof structuredClone == 'undefined' ? JSON.parse(JSON.stringify(this)) : structuredClone(this);
    },
    enumerable: false, configurable: true, writable: true,
  },
  length0: {
...
Object.defineProperties(Array.prototype, {
  ...
  toTree: {
    value: function(o = {}) {
      const { id = 'id', pid = 'pid', tid = 'tid', level = 'level', parent = 'parent', children = 'children', root = 'root', empty = null } = o;
      const r = this.find(v => v[tid] && v[tid] == v[id]), c = [], parents = this.toObject(v => [v[id], v]), childrens = this.toGroup(v => [v[pid], v]);
      for (const v of this) {
        Object.defineProperties(v, {
          [root]: { value: r, enumerable: false, configurable: true, writable: true },
          [parent]: { value: parents[v[pid]] ?? null, enumerable: false, configurable: true, writable: true },
        });
        v[level] = null;
      ...
      c.treeEach(v => v[level] = (v[parent]?.[level] ?? 0) + 1, { children, empty });
      return r ?? c;
    },
    enumerable: false, configurable: true, writable: true,
  },
