...
const d = (prototype, properties) => Object.defineProperties(prototype, Object.entries(Object.keys(properties).map(key => [key, { value: properties[key], enumerable: false, configurable: true, writable: true }])));
