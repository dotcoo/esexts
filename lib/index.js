...
Object.defineProperties(Object.prototype, {
  ...
  treeMap0: {
    value: function(cb, self = true, depth = -1, children = 'children', empty = []) {
...
Object.defineProperties(Array.prototype, {
  ...
  toTree: {
    value: function(o = {}) {
      const { tid = 'tid', id = 'id', pid = 'pid', level = 'level', root = 'root', parent = 'parent', children = 'children', empty = [] } = o;
      const parents = this.toObject(v => [v[id], v]), childrens = this.toGroup(v => [v[pid], v]);
      const r = this.length && tid in this[0] ? this.find(v => v[pid] === 0) : { [id]: 0, [pid]: -1, [root]: null, [parent]: null, [children]: childrens[0] };
      parents[r.id] = r;
      for (const v of this) {
