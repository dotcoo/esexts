...
import { d, staticNew, adapterMethods, iteratorMethods } from './util';
...
d(Array.prototype, {
  ...
  toTree: function(o = {}) {
    ...
    const parents = this.reduce((a, c) => a.$attr(c[id], c), {}), childrens = this.reduce((a, c) => (a.$attr(c[pid], [], { exists: false }).$attr(c[pid]).$push(c), a), {});
