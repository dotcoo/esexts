...
d(Array.prototype, {
  ...
  ...adapterMethods(Array.prototype, null, 't', 'push', 'pop', 'shift', 'unshift', 'splice'),
  ...
  toTree: function(o = {}) {
    ...
    const parents = this.reduce((a, c) => a.attr$(c[id], c), {}), childrens = this.reduce((a, c) => (a.attr$(c[pid], [], false).attr$(c[pid]).push$t(c), a), {});
  ...
  tree2tree: function(...args) {
    return this.tree$tree(...args);
  },
  tree$tree: function(o = {}, r = null, p = null) {
