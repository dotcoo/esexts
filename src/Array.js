...
console.assert(JSON.stringify([1,2,3].push$t(4)) === '[1,2,3,4]', 'error');

// Array.prototype.pop$

console.assert(JSON.stringify([1,2,3].pop$t()) === '[1,2]', 'error');

// Array.prototype.shift$

console.assert(JSON.stringify([1,2,3].shift$t()) === '[2,3]', 'error');

// Array.prototype.unshift$

console.assert(JSON.stringify([1,2,3].unshift$t(4)) === '[4,1,2,3]', 'error');

// Array.prototype.push1

console.assert([1,2,3].push$0(4,5) === 4, 'error');

// Array.prototype.unshift1

console.assert([1,2,3].unshift$0(4,5) === 4, 'error');

// Array.prototype.push3

console.assert(JSON.stringify([1,2,3].push$a(4,5)) === '[4,5]', 'error');

// Array.prototype.unshift3

console.assert(JSON.stringify([1,2,3].unshift$a(4,5)) === '[4,5]', 'error');
